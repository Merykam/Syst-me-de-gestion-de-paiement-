              ...
              <tbody>
                ...
                <tr class="border-b border-dashed last:border-b-0">
                  ...
                  <td class="p-3 pr-0 text-end">
                    <span class="text-center align-baseline inline-flex px-2 py-1 mr-auto items-center font-semibold text-base/none text-warning bg-warning-light rounded-lg">
                       {paim.clientId?.name}</span>
                  </td>
                
                  <td class="p-3 pr-12 text-end">
                    <span class="font-semibold text-primary bg-primary-light text-md/normal">{paim.prixParMois}</span>
                  </td>
                  <td class="p-3 pr-12 text-end">
