...
const Sidebar = ({to}) => {
  ...
  return (
    <div id="view" class=" flex flex-row" x-data="{ sidenav: true }">
      ...
      <div
        id="sidebar"
        class="bg-lime-900 h-screen md:block shadow-xl px-3 w-30 md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-300 ease-in-out"
        x-show="sidenav"
      >
            ...
            <div>
              <h2 class=" text-white font-bold text-x md:text-sm text-center">
               <div>mariem</div>
                ...
                <p class="text-x text-white text-center">Admin</p>
